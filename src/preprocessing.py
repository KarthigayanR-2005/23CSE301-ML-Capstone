...
def make_cluster_preprocessor(features: list[str]) -> Pipeline:
    """Impute + standardise for clustering. Distance-based algorithms require
    comparable scales, so scaling is not optional here."""
    return Pipeline([

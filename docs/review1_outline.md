...
| 10 | Part A: 5 models + confusion matrices | 1.5 | classification owner |
...
- [ ] ✍️ cells in `classification.ipynb` §1–4 written
...
- [ ] **IC-1 raised with the instructor** (were datasets assigned?)
